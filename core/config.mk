...
include vendor/pegasus/config/BoardConfigPegasusOS.mk
...
ifneq ($(wildcard device/pegasus/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/pegasus/sepolicy/common/sepolicy.mk)
endif
